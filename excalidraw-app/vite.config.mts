...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    plugins: [
      ...
      react(),
      checker({
        // Type-check with a build-scoped tsconfig (excludes excalidraw-app/tests):
        // the production image build must not depend on test-only cross-service
        // imports (e.g. the lobby registry e2e suite referencing docker/room).
      ...
      VitePWA({
        ...
        workbox: {
          ...
          globIgnores: [
            // Generated by nginx at container startup. Pre-caching the build
            // placeholder would bypass runtime storage/room configuration.
            "config.js",
            "fonts.css",
            "**/locales/**",
            "service-worker.js",
